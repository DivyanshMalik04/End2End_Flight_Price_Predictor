...
# @st.cache_resource
# def load_model():
#     return joblib.load(r"Flight Price ML Project/rfr_model.joblib")
...
# days_left = st.number_input("Days Left to Departure", min_value=0, max_value=365, value=30)
...
# # Final input in the exact order used in training
# final_input = [
#     departure_encoded,
#     stops_encoded,
#     arrival_encoded,
...
# # Show debug info
# #st.write("Model Input:", final_input)
...
# # Layer for line between source and destination
...
# st.subheader("Source → Destination Map")
...
@st.cache_resource
def load_model():
    return joblib.load("Flight Price ML Project/rfr_model.joblib")
